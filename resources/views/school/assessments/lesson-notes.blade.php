...
<div class="card">
    <div class="card-body">
        <h5 class="card-title mr-4">Lesson Note
            <button type="button" class="btn btn-primary mb-2 btn-sm" data-bs-toggle="modal" data-bs-target="#lessonNoteModal">
                    Add New
                </button>
        </h5>
        ...
        <table class="table display nowrap table-bordered table-striped table-hover mt-3 cardTable" width="100%" id="noteDatatable">
            <thead>
                <tr>
                    <th width="5%">S/N</th>
                    <th>Class</th>
...
<div class="modal fade" id="lessonNoteModal" tabindex="-1" data-bs-backdrop="false">
    <div class="modal-dialog modal-xl ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Lesson Note</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="" method="post" class="" id="lessonNoteForm">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <select name="category_pid" id="noteCategorySelect2" class="form-control form-control-sm">
                            </select>
                            <p class="text-danger category_pid_error"></p>
                        </div>
                        <div class="col-md-4">
                            <select name="class_pid" id="noteClassSelect2" class="form-control form-control-sm">
                            </select>
                            <p class="text-danger class_pid_error"></p>
                        </div>
                        <div class="col-md-4">
                            <select name="arm_pid" id="noteArmSelect2" class="form-control form-control-sm">
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select type="text" name="subject_pid" id="noteArmSubjectSelect2" placeholder="class arm" class="form-control form-control-sm" required>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            Upload <input type="radio" class="radio assessmentType" name="type" id="noteType" value="1">
                            In App <input type="radio" class="radio assessmentType" name="type" id="noteType" value="2">
                    ...
                    <div class="col-md-12" id="lessonText" style="display:none">
                            ...
                            <textarea name="note" class="form-control form-control-sm summer-note"></textarea>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="lessonNoteBtn">Submit</button>
...
<script>
    $(document).ready(function() {
        ...
        multiSelect2('#noteCategorySelect2', 'lessonNoteModal', 'category', 'Select Category');
        $('#noteCategorySelect2').on('change', function(e) {
            var id = $(this).val();
            multiSelect2Post('#noteClassSelect2', 'lessonNoteModal', 'class', id, 'Select Class');
        });

        $('#noteClassSelect2').on('change', function(e) {
            var id = $(this).val();
            multiSelect2Post('#noteArmSelect2', 'lessonNoteModal', 'class-teacher-arm', id, 'Select Class');
        });

        $('#noteArmSelect2').on('change', function(e) {
            var id = $(this).val();
            multiSelect2Post('#noteArmSubjectSelect2', 'lessonNoteModal',  'class-arm-subject', id, 'Select Class Subject');
        });
        ...
        function loadTimetable(arm = null, session = null, term = null) {
            $('#noteDatatable').DataTable({
                "processing": true,
                "serverSide": true,
                responsive: true,
                destroy: true,
                "ajax": {
                    url: "{{route('load.lesson.notes')}}",
                    type: "post",
                    data: {
                        _token: "{{csrf_token()}}",
                        session_pid: session,
