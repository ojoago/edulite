<div class="dropdown">
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item pointer" data-bs-toggle="modal" data-bs-target="#modal{{$data->pid}}">Edit</a></li>
        {{-- <li><a class="dropdown-item" href="#">Details</a></li> --}}
        {{-- <li><a class="dropdown-item" href="#">Arms</a></li> --}}
        <li><a class="dropdown-item bg-danger deleleteClass pointer" pid = "{{$data->pid}}" >Delete</a></li>
    </ul>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" class="" id="updateClassForm{{$data->pid}}">
                    @csrf
                    <select name="category_pid" class="form-control form-control-sm" >
