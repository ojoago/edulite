    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="borderedTabJustified" role="tablist">
            <li class="nav-item flex-fill" role="presentation">
                <!-- <a href="#term-tab"> -->
                <button class="nav-link w-100 active" data-bs-toggle="tab" data-bs-target="#term-tab" type="button" role="tab" aria-controls="term" aria-selected="true">Term</button>
                <!-- </a> -->
            </li>
            <li class="nav-item flex-fill" role="presentation">
                <!-- <a href="#active-tab"> -->
                <button class="nav-link w-100" id="active-tab" data-bs-toggle="tab" data-bs-target="#set-active-tab" type="button" role="tab" aria-controls="active" aria-selected="false">Active Term</button>
                <!-- </a> -->
            </li>
        </ul>
