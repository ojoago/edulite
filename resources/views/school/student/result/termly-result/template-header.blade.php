...
<div class="top-header">
    ...
    <div class="text-content">
        ...
        <small id="moto">MOTTO: {{@$school->school_moto}}</small>
...
<div class="result-title">
    ...
    @endphp
    @if (isset($result_config->title))
        <h3 class="text-uppercase h4">{{$result_config->title ?? 'Continuous Assessment Report' }}</h3>
    @endif
</div>
