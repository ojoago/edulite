        ...
        <div class="row justify-content-center">
            <div class="col-md-3 d-flex flex-column align-items-center justify-content-center">
                <div class="card">
                    <div class="card-body">
                        <div class="pt-4 pb-2">
                            <p class="text-center small">Principal Default Comment</p>
                        </div>
                        <form class="row g-3" id="principalCommentForm">
                            @csrf
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary w-100" type="button" id="principalCommentBtn">Subject</button>
                            </div>
                        </form>
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Principal Default Comments</h5>
...
<script>
    $(document).ready(function() {
        ...
        $('#principalCommentBtn').click(function() {
            submitFormAjax('principalCommentForm', 'principalCommentBtn', "{{route('principal.add.comment')}}");
