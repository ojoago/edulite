 <table width="100%">
     ...
     <tr>
         <td class="inner-td">
             ...
             <b class="lite-color">{{env('APP_NAME',APP_NAME)}}: Making life easier for teacher</b>
             </p>

         </td>
     </tr>
 </table>
 <table width="100%" style="background: #222 !important; color:#fff !important">
     <tr>
         <td class="inner-td">
             <p>{{env('APP_NAME',APP_NAME)}}! The most simple, smart and easy to use school management software as service in Nigeria</p>
         </td>
     </tr>
 </table>
 <table width="100%">
